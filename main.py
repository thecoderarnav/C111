...
print("Mean of 1", mean_sample1)
fig = ff.create_distplot([data],["student marks"], show_hist = False)
fig.add_trace(go.Scatter(x = [mean,mean], y = [0,0.17], mode = "lines", name = "MEAN"))

fig.add_trace(go.Scatter(x = [mean_sample1,mean_sample1], y = [0,0.17], mode = "lines", name = "MEAN sample 1"))

fig.add_trace(go.Scatter(x = [first_sd_start,first_sd_end], y = [0,0.17], mode = "lines", name = "MEAN"))
fig.show()